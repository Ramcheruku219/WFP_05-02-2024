...
import { AddFacility, OperAndMain } from '../DrawerScreens';
...
import Maintaince from '../DrawerScreens/Oper&Main/Maintanance';
        ...
        <View style={{ flex: 1 }}>
            ...
            <MainStack.Navigator>
                ...
                <MainStack.Screen
                    ...
                    component={OperAndMain}
                    options={Options}
                />
                <MainStack.Screen
                    name="Maintenance"
                    headerTitle={<Text>Operation Status and Maintenance Information</Text>}
